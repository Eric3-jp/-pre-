...
if __name__ == '__main__':
    # Plot {3, 7} tessellation (triangles, 7 triangles meet at each vertex) with increased recursion depth for more border triangles
    ax = plot_tessellation(3, 7, k=5, colormap='viridis')
    plt.title("{3, 7} Tessellation")
    plt.show()
